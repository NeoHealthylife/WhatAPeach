            ...
            <Stack w="430px" py={12} px={6}>
              ...
              >
                ...
                <Stack spacing={4}>
                  <HStack>
                    <Box>
                      <UIFormInput name="age" placeholder="Edad"></UIFormInput>
                    </Box>
                    <Box>
                      <UIInput name="height" placeholder="Altura (cm)"></UIInput>
                    </Box>
                  </HStack>
                  <Box w="50%">
                    <UIInput name="weight" placeholder="Peso (kg)"></UIInput>
                  </Box>
                  <HStack>
                    <Box w="50%">
                      <UISelect
                  ...
                  <Box>
                    <FormControl as="fieldset">
                      <FormLabel as="legend">
                        ¿Tienes material para las rutinas de ejercicios?
                      </FormLabel>
                      <RadioGroup defaultValue="Sí">
                        <HStack spacing="24px">
                          <Radio value="Sí" colorScheme="orange">
                            Sí
                          </Radio>
